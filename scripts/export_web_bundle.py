...
print(f"✅ Exported {len(CHINESE_POP_DATABASE)} Chinese songs, {len(WESTERN_POP_DATABASE)} Western songs, and {len(NAMED_PROGRESSIONS)} named progressions to {DATA_DIR}")
